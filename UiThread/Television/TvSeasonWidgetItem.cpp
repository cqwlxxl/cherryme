#include "TvSeasonWidgetItem.h"
#include "ui_TvSeasonWidgetItem.h"

#include <QTimer>

TvSeasonWidgetItem::TvSeasonWidgetItem(TvSeasonData season, QWidget *parent) :
    QWidget(parent),
    ui(new Ui::TvSeasonWidgetItem)
{
    ui->setupUi(this);
...
TvSeasonWidgetItem::~TvSeasonWidgetItem()
{
    delete ui;
}

///设置评分
void TvSeasonWidgetItem::setPoint(int point)
{
    if(point == 0)
    {
...
void TvSeasonWidgetItem::setTag1(bool tag1)
{
...
void TvSeasonWidgetItem::setTag2(bool tag2)
{
...
void TvSeasonWidgetItem::setTag3(bool tag3)
{
...
///设置发布日期
void TvSeasonWidgetItem::setReleaseDate()
{
