#include "TvIpWidgetItem.h"
#include "ui_TvIpWidgetItem.h"

#include <QTimer>

TvIpWidgetItem::TvIpWidgetItem(TvIpData ip, QWidget *parent) :
    QWidget(parent),
    ui(new Ui::TvIpWidgetItem)
{
    ui->setupUi(this);
...
TvIpWidgetItem::~TvIpWidgetItem()
{
    delete ui;
}

///设置评分
void TvIpWidgetItem::setPoint(int point)
{
    if(point == 0)
    {
...
void TvIpWidgetItem::setTag1(bool tag1)
{
...
void TvIpWidgetItem::setTag2(bool tag2)
{
...
void TvIpWidgetItem::setTag3(bool tag3)
{
...
///设置追剧
void TvIpWidgetItem::setZhuiju(bool zhuiju)
{
    ui->label_Zhuiju->setVisible(zhuiju);
    if(zhuiju)
    {
        ui->label_Zhuiju->setStyleSheet("QLabel{color:red;margin-left:3px;}");
    }
}
